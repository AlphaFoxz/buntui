...
### P0-1 Rendering pipeline is incomplete — [#1](https://github.com/AlphaFoxz/buntui/issues/1)
...
### P0-2 POSIX input handling is not implemented — [#2](https://github.com/AlphaFoxz/buntui/issues/2)
...
### P0-3 Text component textPtr is commented out — [#3](https://github.com/AlphaFoxz/buntui/issues/3)
...
### P0-4 No event processing in main app loop — [#4](https://github.com/AlphaFoxz/buntui/issues/4)
...
### P1-1 Event header size mismatch — [#6](https://github.com/AlphaFoxz/buntui/issues/6)
...
### P1-2 Global singleton event bus — [#7](https://github.com/AlphaFoxz/buntui/issues/7)
...
### P1-3 Remove stale files from native source tree — [#5](https://github.com/AlphaFoxz/buntui/issues/5)
...
### P2-1 Heavy use of `any` types — [#9](https://github.com/AlphaFoxz/buntui/issues/9)
...
### P2-2 Misc code quality issues — [#16](https://github.com/AlphaFoxz/buntui/issues/16)
...
### P3-1 Missing test coverage for core modules — [#8](https://github.com/AlphaFoxz/buntui/issues/8)
