<template>
  <Box
    ...
    width="45%"
    :height="5"
    colorBorder="rgba(137,180,250,0.5)"
    borderStyle="rounded"
  >
  ...
  <Box
    ...
    width="45%"
    :height="5"
    colorBorder="rgba(250,179,135,0.5)"
    borderStyle="rounded"
  >
  ...
  <Box
    ...
    width="45%"
    :height="5"
    colorBorder="rgba(166,227,161,0.5)"
    borderStyle="rounded"
  >
    ...
    <Text
      ...
      value="Bold + Underline 组合"
    />
    <Text
      styleModifier="crossedout"
      colorFg="rgba(243,139,168,1)"
  ...
  <Box
    ...
    width="45%"
    :height="5"
    colorBorder="rgba(203,166,245,0.5)"
    borderStyle="rounded"
  >
  ...
  <Box
    ...
    width="95%"
    :height="5"
    colorBorder="rgba(249,226,175,0.5)"
    borderStyle="rounded"
  >
    <Text
      colorFg="rgba(249,226,175,1)"
      value="▶ Marquee Scroll (overflow='marquee')"
    />
    <Text
      :width="60"
      overflow="marquee"
  ...
  <Box
    ...
    width="45%"
    :height="5"
    colorBorder="rgba(148,226,213,0.5)"
    borderStyle="rounded"
  >
    <Text colorFg="rgba(148,226,213,1)" value="▶ Bg Color" />
    <Text
      colorFg="rgba(30,30,46,1)"
      colorBg="rgba(243,139,168,1)"
      value=" Red BG "
    />
    <Text
      colorFg="rgba(30,30,46,1)"
      colorBg="rgba(137,180,250,1)"
      value=" Blue BG "
    />
    <Text
      colorFg="rgba(30,30,46,1)"
  ...
  <Box
    ...
    width="45%"
    :height="5"
    colorBorder="rgba(245,194,231,0.5)"
    borderStyle="rounded"
  >
