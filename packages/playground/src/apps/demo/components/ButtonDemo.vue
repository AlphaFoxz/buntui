<template>
  ...
  <Button
    ...
    colorBorderNormal="rgba(137,180,250,0.5)"
    colorBgHovered="rgba(137,180,250,0.3)"
    colorFgHovered="rgba(137,180,250,1)"
    colorBorderHovered="rgba(137,180,250,1)"
    colorBgPressed="rgba(137,180,250,0.5)"
    colorFgPressed="rgba(30,30,46,1)"
    colorBorderPressed="rgba(137,180,250,1)"
  ...
  <Button
    ...
    colorBorderNormal="rgba(166,227,161,0.5)"
    colorBgHovered="rgba(166,227,161,0.3)"
    colorFgHovered="rgba(166,227,161,1)"
    colorBorderHovered="rgba(166,227,161,1)"
    colorBgPressed="rgba(166,227,161,0.5)"
    colorFgPressed="rgba(30,30,46,1)"
    colorBorderPressed="rgba(166,227,161,1)"
  ...
  <Button
    ...
    colorBorderNormal="rgba(249,226,175,0.5)"
    colorBgHovered="rgba(249,226,175,0.3)"
    colorFgHovered="rgba(249,226,175,1)"
    colorBorderHovered="rgba(249,226,175,1)"
    colorBgPressed="rgba(249,226,175,0.5)"
    colorFgPressed="rgba(30,30,46,1)"
    colorBorderPressed="rgba(249,226,175,1)"
