<template>
    ...
    <Box x="50%" :y="4" width="45%" :height="15" borderStyle="rounded" :direction="'vertical'" :gap="1">
    ...
    <ScrollBox :x="1" :y="21" width="45%" :height="8" borderStyle="rounded" :gap="1">
        <template>
            <Button
                v-for="(_, index) in 12"
                :x="1"
    ...
    <Box x="50%" :y="20" width="45%" :height="8" borderStyle="rounded" :direction="'vertical'" :gap="1">
