...
const tokyoNightMoonColors: TuiThemeColors = {
  ...
  borderHover: hex(0x4A, 0x52, 0x75),
...
const highContrastColors: TuiThemeColors = {
  ...
  borderHover: hex(0xAA, 0xAA, 0xAA),
