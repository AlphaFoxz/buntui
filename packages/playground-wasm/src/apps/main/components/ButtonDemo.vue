<template>
  ...
  <Text
    :x="2"
    :y="5"
    value="value           string          Button label text"
  />
  ...
  <Text
    :x="2"
    :y="8"
    value="borderStyle*     TuiBorderStyleName  Per-state border styles"
  />
  <Text
    :x="2"
    :y="9"
  ...
  <Text
    :x="2"
    :y="31"
    value="▸ Events: click (Enter/Space)"
    styleModifier="bold"
  />
</template>
